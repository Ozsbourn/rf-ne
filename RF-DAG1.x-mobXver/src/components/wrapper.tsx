    ...
    return (
        <div className='dndflow'>
            <ReactFlowProvider>
                ...
                >
                    <p>В левой части расположен редактор кода и кнопки: для применения изменений с текстового редактора в нодовый, и наоборот, соответственно. <br/>В правой: элементы управления для работы с файлами и базовая нода для D&D режима работы редактора.<br/>Для MVP ограничен набор нод до С4 (все С4 сущности выводятся из базовой) - просто редактируйте поля двойным кликом по текстовым полям (со связями работает аналогично).</p>
                    <br/>
